...
int newGeneration(Individual *survivors, Individual *pool, int survivorSize, int poolSize, double annealing, std::mt19937_64 & rng, const cudaConstants* gConstant, thruster<double>& thrust, double generation);
