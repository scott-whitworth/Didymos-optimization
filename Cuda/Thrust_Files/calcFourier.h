...
template <class T> __host__ __device__ T calc_gamma(const coefficients<T> & coeff,const T & curTime, const T & timeFinal, thruster<class T> thrust);
...
template <class T> __host__ __device__ T calc_tau(const coefficients<T> & coeff,const T & curTime, const T & timeFinal, thruster<class T> thrust);
