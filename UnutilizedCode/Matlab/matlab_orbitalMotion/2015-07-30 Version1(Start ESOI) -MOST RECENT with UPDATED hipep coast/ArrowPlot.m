...
function [sizeArrReturn,xReturn,yReturn,uReturn,vReturn] = ArrowPlot(YdataReturn,YdataForward,YdataWait,timeWait,gammaReturn,gammaForward,direction,lineWidth,asteroidName,powerLevel,thrusterName,sizeArrReturn,xReturn,yReturn,uReturn,vReturn)
