...
T stepSize, elements<T> *y, const T & absTol, coefficients<T> coeff, const T & accel, T *gamma, T *tau, int & lastStep,T *accel_output, const T & dryMass);
...
T stepSize, elements<T> &y, const T & absTol, coefficients<T> coeff, const T & accel, const T & dryMass);
